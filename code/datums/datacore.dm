...
*/
	...
	switch(job_clothes)
		if(JOB_TITLE_HOP)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "hop_alt_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_REPRESENTATIVE)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "officer_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "laceups"), ICON_UNDERLAY)
		if(JOB_TITLE_BLUESHIELD)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "officer_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "jackboots"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_GLOVES, "swat_gl"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "blueshield"), ICON_OVERLAY)
		if(JOB_TITLE_JUDGE)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "really_black_suit_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "laceups"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "judge"), ICON_OVERLAY)
		if(JOB_TITLE_BARTENDER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "ba_suit_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_BOTANIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "hydroponics_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_CHEF)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "chef_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_JANITOR)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "janitor_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_LIBRARIAN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "red_suit_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_CLOWN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "clown_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "clown"), ICON_UNDERLAY)
		if(JOB_TITLE_MIME)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "mime_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_QUARTERMASTER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "qm_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_CARGOTECH)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "cargotech_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_MINER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "explorer_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "explorer"), ICON_UNDERLAY)
		if(JOB_TITLE_MINING_MEDIC)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "mining_medic_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
		if("Lawyer")
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "internalaffairs_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_CHAPLAIN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "chapblack_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_RD)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "director_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_SCIENTIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "toxinswhite_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_tox_open"), ICON_OVERLAY)
		if(JOB_TITLE_SCIENTIST_STUDENT)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "student_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_tox_open"), ICON_OVERLAY)
		if(JOB_TITLE_CHEMIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "chemistrywhite_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_chem_open"), ICON_OVERLAY)
		if(JOB_TITLE_CMO)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "cmo_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_cmo_open"), ICON_OVERLAY)
		if(JOB_TITLE_DOCTOR)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "medical_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_CORONER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "scrubsblack_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_mort_open"), ICON_OVERLAY)
		if(JOB_TITLE_GENETICIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "geneticswhite_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_gen_open"), ICON_OVERLAY)
		if(JOB_TITLE_VIROLOGIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "virologywhite_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_vir_open"), ICON_OVERLAY)
		if(JOB_TITLE_PSYCHIATRIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "psych_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "laceups"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_open"), ICON_UNDERLAY)
		if(JOB_TITLE_PARAMEDIC)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "paramedic_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		if(JOB_TITLE_INTERN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "intern_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_CAPTAIN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "captain_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_HOS)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "hosred_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_WARDEN)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "warden_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_DETECTIVE)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "detective_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "detective"), ICON_OVERLAY)
		if(JOB_TITLE_PILOT)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "secred_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "jackboots"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "bomber"), ICON_OVERLAY)
		if(JOB_TITLE_BRIGDOC)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "medical_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "fr_jacket_open"), ICON_OVERLAY)
		if(JOB_TITLE_OFFICER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "secred_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_CHIEF)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "chief_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_BELT, "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ENGINEER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "engine_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_BELT, "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ATMOSTECH)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "atmos_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_BELT, "utility"), ICON_OVERLAY)
		if(JOB_TITLE_MECHANIC)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "mechanic_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_BELT, "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ENGINEER_TRAINEE)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "trainee_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_BELT, "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ROBOTICIST)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "robotics_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon(DEFAULT_ICON_OUTER_SUIT, "labcoat_open"), ICON_OVERLAY)
		if("Syndicate Agent")
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "syndicate_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
		...
		if(JOB_TITLE_PRISONER)
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "orange_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "orange"), ICON_UNDERLAY)
		else if(H.mind && (H.mind.assigned_role in get_all_centcom_jobs()))
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "officer_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "laceups"), ICON_UNDERLAY)
		else
			clothes_s = new /icon(DEFAULT_ICON_JUMPSUIT, "grey_s")
			clothes_s.Blend(new /icon(DEFAULT_ICON_SHOES, "black"), ICON_UNDERLAY)
